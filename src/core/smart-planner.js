...
(() => {
  ...
  function inferAssignmentResourceLinks(item) {
    ...
    for (const match of source.matchAll(urlPattern)) {
      ...
      else if (/notebooklm\.google\.com|illuminate\.google\.com|quizlet\.com|coconote\.app|notion\.so|knowt\.com|studyfetch\.com|turbolearn\.ai|mindgrasp\.ai|studyx\.ai|gizmo\.ai|brainscape\.com|remnote\.com/.test(lower)) add('ai study guide', url);
      else if (/otter\.ai|granola\.ai|fireflies\.ai|fathom\.video|read\.ai|recall\.ai|tldv\.io|supernormal\.com|plaud\.ai|limitless\.ai|tactiq\.io|meetgeek\.ai|circleback\.ai|notta\.ai|jamie\.ai|sembly\.ai|wisprflow\.ai/.test(lower)) add('ai notes/transcript', url);
