...
(() => {
  ...
  function buildTodayCourseBrief(items, now = new Date()) {
    ...
    return { generatedAt, dueSoonCount: dueSoon.length, overdueCount: overdue.length, priorityFilters, highLeverage, markdown };
  }
