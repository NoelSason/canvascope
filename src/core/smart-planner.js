...
(() => {
  ...
  function inferAssignmentResourceLinks(item) {
    ...
    for (const match of source.matchAll(urlPattern)) {
      ...
      else if (/notebooklm\.google\.com|quizlet\.com|coconote\.app|notion\.so/.test(lower)) add('ai study guide', url);
      else if (/otter\.ai|granola\.ai|fireflies\.ai|fathom\.video|read\.ai|tldv\.io|supernormal\.com|plaud\.ai/.test(lower)) add('ai notes/transcript', url);
