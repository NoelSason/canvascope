 ...
 *
 * Exposes window.CanvascopeAttachFromLectra with three primitives that any
...
(function () {
  ...
  if (window.CanvascopeAttachFromLectra) return;

  const NS = 'canvascope-attach-from-lectra';
  ...
  function fillFileInput(inputEl, file) {
    ...
    try {
      ...
      console.warn('[Canvascope][AttachFromLectra] fillFileInput failed', e);
      return false;
    }
  }
  ...
  window.CanvascopeAttachFromLectra = {
    openPicker,
